  ...
  return (
    ...
    >
      ...
      <div className="card-actions">
        <button type="button" className="btn btn-ghost" onClick={() => setEditOpen(true)} title="Edit task">
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg>
          Edit
        </button>
        {!task.completed && (
          <>
            <button type="button" className="btn btn-ghost btn-sm" onClick={() => setSubModal('note')}>+ Subnote</button>
            <button type="button" className="btn btn-ghost btn-sm" onClick={() => setSubModal('task')}>+ Subtask</button>
            <button type="button" className="btn btn-ghost btn-complete" onClick={() => onCompleteTask(task.id)}>
